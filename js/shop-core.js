...
const i18nShop = {
  FR: {
    ...
    derivedIntro:"Le prix de ces objets ne se relève pas dans leur propre pack : il se déduit d'autres objets. Soit parce qu'aucun pack ne les vend, soit parce que le relevé, tout exact qu'il est, donnait un prix unitaire absurde — un pack avare sur un objet ne rend pas cet objet plus précieux. Une caisse, elle, vaut la somme de ce qu'elle rend : quand son butin est tiré au sort, chaque quantité ci-dessous est une moyenne (chaque lot × sa probabilité).",
    derivedSum:"Soit {p} \u00F7 {q} \u00D7 {f} = {b}",
    derivedSumAlt:"Soit la valeur de « {n} » \u00D7 {f} = {b}",
    derivedSumSame:"Soit la valeur de « {n} », donc {b}",
    derivedSumMulti:"Soit {t} = {b}",
    derivedTerm:"{f} \u00D7 « {n} »",
    scaled:"Barème",
