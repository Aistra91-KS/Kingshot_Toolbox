...
const i18nShopEvent = {
  FR: {
    ...
    evIntro: "Coche ce que tu as acheté chaque jour — ou rien si tu es F2P. L'outil additionne tout ce que l'événement rapporte (missions, pack gratuit, piste gratuite, paliers, packs) plus ton panier de la boutique ci-dessous, et compare cette valeur à ta dépense réelle.",
    ...
    evBudgetTip: "Reporte cette monnaie dans « Ma monnaie » du tableau ci-dessous, pour voir ce que tu peux réellement acheter.",
    ...
    evCoinsRowSub: "se dépensent dans la boutique ci-dessous",
    ...
    evCartEmpty: "Panier boutique vide — choisis des objets dans le tableau ci-dessous pour valoriser ta monnaie.",
  ...
  EN: {
    ...
    evIntro: "Tick what you bought each day — or nothing if you are F2P. The tool adds up everything the event gives (missions, free pack, free track, milestones, packs) plus your cart in the shop below, and compares that value to what you actually spent.",
    ...
    evBudgetTip: "Copies this currency into “My currency” of the table below, to see what you can actually buy.",
    ...
    evCoinsRowSub: "spent in the shop below",
    ...
    evCartEmpty: "Shop cart is empty — pick items in the table below to turn your currency into value.",
